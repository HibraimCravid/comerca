  ...
  return {
    ...
    body: JSON.stringify({
      ...
      message: delivered
        ...
        : 'Serviço de email ainda não está configurado (ver RESEND_API_KEY nas variáveis de ambiente da Netlify). O código foi gerado e registado nos logs da função para testes.',
    }),
  };
};
