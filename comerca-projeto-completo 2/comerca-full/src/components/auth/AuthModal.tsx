...
export const AuthModal: React.FC = () => {
  ...
  const sendVerificationCode = async () => {
    ...
    try {
      ...
      if (!data.delivered) {
        // Email service not configured on the server yet — the code was
        // generated and logged server-side only, never shown here.
        setCodeInfo(
          'Ainda não há um serviço de email ligado neste servidor, por isso o código não foi entregue de verdade. Configure RESEND_API_KEY nas variáveis de ambiente para ativar o envio real.'
        );
      }
    } catch {
